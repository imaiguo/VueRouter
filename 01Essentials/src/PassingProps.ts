...
import PassingProps from './components/PassingPropsRoutes.vue'
import router from './router/PassingPropsRoutes'

createApp(PassingProps).use(router).mount('#PassingProps')
